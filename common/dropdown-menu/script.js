jQuery(function (t) {
  ...
  var r,
    s = "bs.navbar-dropdown",
    n = "." + s,
    i = ".data-api",
    o = {
      SCROLL_DATA_API: "scroll" + n + i,
      RESIZE_DATA_API: "resize" + n + i,
            ...
            "show" == e.type
              ? (t(h.BODY).addClass(a.DROPDOWN_OPEN),
                t(this)
                  .addClass(a.OPENED)
                  .removeClass(a.SHORT)
                  .removeClass(a.BG_COLOR))
              : (t(h.BODY).removeClass(a.DROPDOWN_OPEN),
                t(this).addClass(a.BG_COLOR).removeClass(a.OPENED),
  ...
  (function (t) {
    var e = "navDropdown",
      ...
      o = {
        ...
        RESIZE_DATA_API: "resize" + s + n,
        KEYDOWN_DATA_API: "keydown" + s + n,
      },
      ...
      c = (function () {
        function e(e, r) {
          ...
          for (var s = 0; s < e.length; s++) this[s] = e[s];
        }
        return (
          ...
          (e.prototype.parents = function (r) {
            var s = t(this)
              ...
              .parentsUntil(p.BASE, p.DROPDOWN);
            return (
              ":upper" === r && (s = s.last()),
              (s = s.find(">" + p.DATA_TOGGLE)),
              new e(s, this)
            );
          }),
            ...
            return (
              t(this).each(function () {
                ...
                if (o.is(":root")) n = t(this);
                  ...
                  n = t(this)
                    .parent()
                    .find(">" + p.DROPDOWN_MENU);
                }
                (i = r
                  ? n.find("a")
                  : o.is(":root")
                  ? n.find(">li>a")
                  : n.find(">a, >" + p.DROPDOWN + ">a")),
                  i.each(function () {
                    (r && !this.offsetWidth && !this.offsetHeight) ||
                      this.disabled ||
                      t(this).is(p.DATA_BUTTON) ||
                      t(this).hasClass(l.DISABLED) ||
                      ~t.inArray(this, s) ||
                      s.push(this);
                  });
              }),
          ...
          (e.prototype.root = function () {
            return new e(t(this).closest(p.BASE), this);
          }),
          (e.prototype.jump = function (r) {
            ...
            var s,
              n = this.eq(0);
            s =
              this.is(":flat") || n.is(":upper")
                ? n.root().children(this.is(":flat"))
                : n.parent().children();
            var i = t.inArray(this[0], s);
            if (!s.length || !~i) return new e([], this);
            if ("next" == r) {
              if (((i += 1), i < s.length)) return new e(s[i], this);
              r = "first";
            } else if ("prev" == r) {
              if (((i -= 1), i >= 0)) return new e(s[i], this);
              r = "last";
            }
            return "first" == r
              ? new e(s[0], this)
              : "last" == r
              ? new e(s[s.length - 1], this)
              : new e([], this);
          }),
          ...
          (e.prototype.is = function (e) {
            for (
              var r = t(this), s = (e || "").split(/(?=[*#.\[:\s])/);
              (e = s.pop());

            )
              switch (e) {
                case ":root":
                  if (!r.is(p.BASE)) return !1;
                  break;
                case ":upper":
                  if (!r.parent().parent().is(p.BASE)) return !1;
                  break;
                case ":opened":
                case ":closed":
                  if ((":opened" == e) != r.parent().hasClass(l.OPEN))
                    return !1;
                case ":toggle":
                  if (!r.is(p.DATA_TOGGLE)) return !1;
                  break;
                default:
    ...
    (d.prototype.toggle = function (e) {
      ...
      var r = t(this.parentNode),
        s = r.hasClass(l.OPEN),
        n = d._isCollapsed(t(this).closest(p.BASE));
      if (
        (d._clearMenus(
          t.Event("click", { target: this, toggles: n ? [this] : null })
        ),
        s)
      )
        return !1;
      if (
        ...
        !r.closest(p.DROPDOWN + "." + l.OPEN).length
      ) {
        var i = document.createElement("div");
        (i.className = l.BACKDROP),
          (i.style.background = "transparent"),
          t(i).insertBefore(t(this).closest(p.BASE)),
      ...
      (d._clearMenus = function (e) {
        if (((e = e || {}), 3 !== e.which)) {
          var r;
          if (this === document) {
            var s = t(e.target).closest(p.BASE);
            if (
              (s[0] ||
                (!t(e.target).is(".navbar") &&
                  !t(e.target).parent().is(".navbar")) ||
                (s = t(e.target).find(p.BASE)),
              t(e.target).is(
                "a:not([disabled], ." + l.DISABLED + ", " + p.DATA_TOGGLE + ")"
              ))
            )
              r = e.target;
            else if (d._isCollapsed(s))
              return void t(document).trigger(
                t.Event(o.COLLAPSE, { relatedTarget: s[0] })
              );
          } else if (e.target && t(e.target).hasClass(l.BACKDROP)) {
            var n = t(e.target).next();
            n.is(p.BASE) && d._isCollapsed(n) && (r = n[0]);
          }
          var i = function () {
            return !1;
          };
          if (e.target && t(e.target).is(p.DATA_TOGGLE))
            i = t(e.target.parentNode)
              .parents(p.DROPDOWN)
              .find(">" + p.DATA_TOGGLE);
          else {
            var a = t(p.BACKDROP)[0];
            a && a.parentNode.removeChild(a);
          }
          for (
            var h = e.toggles || t.makeArray(t(p.DATA_TOGGLE).not(i)), c = 0;
            c < h.length;
            c++
          ) {
            var u = h[c].parentNode,
              f = { relatedTarget: h[c] };
            if (
              t(u).hasClass(l.OPEN) &&
              ("click" !== e.type ||
                !/input|textarea/i.test(e.target.tagName) ||
                !t.contains(u, e.target))
            ) {
              var A = t.Event(o.HIDE, f);
              t(u).trigger(A),
                A.isDefaultPrevented() ||
                  (h[c].setAttribute("aria-expanded", "false"),
                  t(u).removeClass(l.OPEN).trigger(t.Event(o.HIDDEN, f)));
            }
          }
          r && t(document).trigger(t.Event(o.COLLAPSE, { relatedTarget: r }));
        }
      }),
        ...
        if (!/input|textarea/i.test(e.target.tagName)) {
          ...
          if (r) {
            if ((e.preventDefault(), e.stopPropagation(), e.which == a.ESC)) {
              ...
              var n = t(e.target)
                .parents(p.DROPDOWN + "." + l.OPEN)
                .last()
                .find(">" + p.DATA_TOGGLE);
              return d._clearMenus(), void n.trigger("focus");
            }
      ...
      (d._dataApiResizeHandler = function () {
        t(p.BASE).each(function () {
          var e = d._isCollapsed(this);
          t(this).find(p.DROPDOWN).removeClass(l.OPEN),
            t(this)
              .find('[aria-expanded="true"]')
              .attr("aria-expanded", "false");
          var r = t(p.BACKDROP)[0];
          r && r.parentNode.removeChild(r),
            e != t(this).hasClass(l.SM) &&
              (e ? t(this).addClass(l.SM) : t(this).removeClass(l.SM));
        });
      }),
      (t.fn[e] = function (e) {
        return this.each(function () {
          var s = t(this).data(r);
          if ((s || t(this).data(r, (s = new d(this))), "string" == typeof e)) {
      ...
      t(document)
        .on(o.KEYDOWN_DATA_API, p.BASE, d._dataApiKeydownHandler)
        .on(o.CLICK_DATA_API, d._clearMenus)
        .on(o.CLICK_DATA_API, p.DATA_TOGGLE, d.prototype.toggle)
        .on(o.CLICK_DATA_API, p.FORM_CHILD, function (t) {
          t.stopPropagation();
        }),
